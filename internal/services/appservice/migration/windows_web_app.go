...
type WindowsWebAppV0toV1 struct{}

var _ pluginsdk.StateUpgrade = WindowsWebAppV0toV1{}

func (w WindowsWebAppV0toV1) Schema() map[string]*pluginsdk.Schema {
...
func (w WindowsWebAppV0toV1) UpgradeFunc() pluginsdk.StateUpgraderFunc {
